...
class _SocialListPageState extends State<SocialListPage> {
  ...
  Future<void> _load({bool refresh = false}) async {
    ...
    final result = _isFollowers
        ...
        : await _api.getUserFollowing(widget.username,
            page: _page, perPage: 30);
    ...
    return Scaffold(
      ...
      body: _loading && _users.isEmpty
          ...
          : _error.isNotEmpty && _users.isEmpty
              ...
              : _users.isEmpty
                  ? _EmptyView(message: _isFollowers ? '暂无粉丝' : '暂无关注')
                  : RefreshIndicator(
...
class _ErrorView extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => ApiErrorView(
        message: message,
        onRetry: onRetry,
        title: '社交信息加载失败',
      );
