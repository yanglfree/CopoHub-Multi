...
详细的开发文档、设计方案及项目演示均存放于 [docs/](./docs) 目录。关于 AI Agent 的特定规则及兼容性指南，请参考 [AGENTS.md](./AGENTS.md)。
